...
## Description
This is a simple Javascript console application that allows the user to be able to see the movie tickets as well as buy them.

## How to use 
1. clone the respiratory using

git clone https://github.com/luvley-dee48/respository.git
...
Incase of any query, or issues with the code please reach me deborahmuoti@student.moringaschool.com
